...
from django_project.Hand_pose_estimation_part.data.transformations import rotatePoint2D, rotatePoints2D, rotatePoints3D, transformPoints2D, transformPoint2D
...
class HandDetector(object):
	...
	def __init__(self, dpt, fx, fy, importer=None, refineNet=None,maxDepth=2000,minDepth=20):
		"""
		Constructor
	...
	def cropArea3D(self, com=None, size=(250, 250, 250), dsize=(128, 128), docom=False):
		...
		print("1- ax.imshow(self.dpt, cmap=matplotlib.cm.jet)")
		...
		rz = self.resizeCrop(cropped, sz)
		"""plt.imshow(rz)
		t=transformPoint2D(com,scale*trans)
...
"""
		...
		return ret, numpy.dot(off, numpy.dot(scale, trans)), com, bounds
