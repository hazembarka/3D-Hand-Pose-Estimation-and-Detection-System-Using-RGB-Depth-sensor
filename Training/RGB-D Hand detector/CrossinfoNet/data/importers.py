...
class MSRA15Importer(DepthImporter):
    ...
    def __init__(self, basepath, useCache=False, cacheDir='./cache/', refineNet=None, detectorNet=None, derotNet=None):
        """
        Constructor
        ...
        for line in range(joints3D.shape[0]):
            ...
            try:
                ...
                if cube is None:
                    ...
                    cube_=cube
                dpt, M, com,box = hd.cropArea3D(com=gtorig[self.crop_joint_idx], size=cube_, docom=docom,dsize=(96,96))
            except UserWarning:
                print(("Skipping image {}, no hand detected".format(dptFileName)))
                continue
